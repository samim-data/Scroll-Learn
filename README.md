...
AI deep-dives use metadata, not transcripts. Claude/GPT sees the title, description, and channel — not the actual video content. Good enough for most well-described videos. To do it properly, I'd need to pull YouTube transcripts, which is a bigger feature.
...
License
MIT — do what you want with the code. If you build something interesting from it, tell me.
